...
public final class ItemAppointmentBinding implements ViewBinding {
  ...
  private ItemAppointmentBinding(@NonNull ConstraintLayout rootView, @NonNull Button approveButton,
      @NonNull TextView dateTextView, @NonNull Button rejectButton,
  ...
  public static ItemAppointmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAppointmentBinding((ConstraintLayout) rootView, approveButton, dateTextView,
          rejectButton, timeTextView);
    }

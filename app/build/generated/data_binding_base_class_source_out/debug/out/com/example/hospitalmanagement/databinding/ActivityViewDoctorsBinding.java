...
public final class ActivityViewDoctorsBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView lvDoctors;

  private ActivityViewDoctorsBinding(@NonNull LinearLayout rootView, @NonNull ListView lvDoctors) {
    this.rootView = rootView;
    this.lvDoctors = lvDoctors;
  }
  ...
  public static ActivityViewDoctorsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.lvDoctors;
      ListView lvDoctors = ViewBindings.findChildViewById(rootView, id);
      if (lvDoctors == null) {
        break missingId;
      }

      return new ActivityViewDoctorsBinding((LinearLayout) rootView, lvDoctors);
    }
